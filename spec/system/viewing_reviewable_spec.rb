...
describe "Viewing reviewable upload" do
  ...
  it "Allows to delete file" do
    ...
    review_page.select_bundled_action(reviewable, "upload-remove_file")
  ...
  it "Allows to delete file and posts" do
    ...
    review_page.select_bundled_action(reviewable, "upload-remove_file_and_delete_posts")
  ...
  it "Allows to delete file and user" do
    ...
    review_page.select_bundled_action(reviewable, "upload-remove_file_and_delete_user")
